...
pub fn day8_part1(c: &mut Criterion) {
    let input = include_str!("../input/2024/day8.txt");
    c.bench_function("day8::part1", |b| b.iter(|| day8::part1(black_box(input))));
}
pub fn day8_part2(c: &mut Criterion) {
    let input = include_str!("../input/2024/day8.txt");
    c.bench_function("day8::part2", |b| b.iter(|| day8::part2(black_box(input))));
}

pub fn day9_part1(c: &mut Criterion) {
    let input = include_str!("../input/2024/day9.txt");
    c.bench_function("day9::part1", |b| b.iter(|| day9::part1(black_box(input))));
}
pub fn day9_part2(c: &mut Criterion) {
    let input = include_str!("../input/2024/day9.txt");
    c.bench_function("day9::part2", |b| b.iter(|| day9::part2(black_box(input))));
}

criterion_group!(
    benches, day1_part1, day1_part2, day2_part1, day2_part2, day3_part1, day3_part2, day4_part1,
    day4_part2, day5_part1, day5_part2, day6_part1, day6_part2, day7_part1, day7_part2, day8_part1,
    day8_part2, day9_part1, day9_part2
);
